const AboutPage = () => {
    const boxes = [
        {
            icon: <i className="fas fa-user text-2xl md:text-5xl"></i>,
            heading: "10.5K",
            second_heading: "Customers Daily",
        },
        {
            icon: <i className="fas fa-coins text-2xl md:text-5xl"></i>,
            heading: "25K",
            second_heading: "Annual Gross",
        },
        {
            icon: <i className="fab fa-product-hunt text-2xl md:text-5xl"></i>,
            heading: "33K",
            second_heading: "Monthly Product Sales",
        },
        {
            icon: <i className="fab fa-intercom text-2xl md:text-5xl"></i>,
            heading: "24 / 7 ",
            second_heading: "Customer support day and night"
        },  
        {
            icon: <i className="fas fa-shipping-fast text-2xl md:text-5xl"></i>,
            heading: "Free & Fast Delivery",
            second_heading: "Free delivery for all orders above $300"
        },
        {
            icon: <i className="fas fa-exchange-alt text-2xl md:text-5xl"></i>,
    ...
    return (
        <div className="w-full px-5 md:px-56 py-16 flex flex-col gap-y-28">
            <div className="w-full flex flex-col-reverse md:flex md:flex-row gap-5">
                <div className="w-full md:w-1/2 flex flex-col gap-y-5 justify-center">
            ...
            <div className="w-full flex flex-wrap justify-around gap-5">
                {boxes.map((box, idx) =>
                    <div className="w-32 h-fit md:w-64 md:h-64 border border-gray-500 rounded-md p-5 flex flex-col items-center justify-center gap-2" key={idx}>
                        {box.icon}
                        <div className="text-lg md:text-2xl text-center font-semibold">{box.heading}</div>
                        <div className="text-center text-sm md:text-base">{box.second_heading}</div>
                    </div>
                )}
            </div>
        </div>
