const Footer = () => {
    return (
        <div className="w-full h-max px-2 md:px-56 pt-5 md:pt-20 bg-black">
            <div className="flex flex-wrap md:justify-between">
                <div className="flex flex-col text-white space-y-2 md:space-y-5">
                    <div className="text-2xl md:text-4xl">Everyone Shops</div>
                    <div className="text-xl md:text-2xl">Subscribe</div>
                ...
                <div className="flex flex-col text-white space-y-2 md:space-y-5">
                    <div className="text-xl md:text-2xl mt-14">Address</div>
                ...
                <div className="flex flex-col text-white space-y-2 md:space-y-5">
                    <div className="text-xl md:text-2xl mt-14 cursor-pointer">Quick Links</div>
                    <div className="cursor-pointer">Privacy Policy</div>
                    <div className="cursor-pointer">Terms of use</div>
                    <div className="cursor-pointer">FAQ</div>
                </div>
            </div>
            <div className="flex justify-center text-sm md:text-base text-white mt-10 mb-2">
